# Architecture: Vision RAG <!-- omit in toc -->
  ...
  - [API Endpoints](#api-endpoints)
    ...
    - [Search (POST /search)](#search-post-search)
      - [Search endpoint input](#search-endpoint-input)
        - [Search endpoint input sample](#search-endpoint-input-sample)
      - [Search endpoint output](#search-endpoint-output)
        - [Search endpoint output sample](#search-endpoint-output-sample)
    - [Chat (POST /chat)](#chat-post-chat)
      - [Chat endpoint input](#chat-endpoint-input)
        - [Chat endpoint input sample](#chat-endpoint-input-sample)
